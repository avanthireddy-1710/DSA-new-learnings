/*
Time Complexity:
Time complexity is NOT the actual time taken for a program to run but 
...
Everytime worst case scenario should be considered to optimize the working.
  ...
  if a program runs optimally in worst case,it'll definitely be optimal in all
  other cases possible
big O is a function in terms of n which represents time complexity of a given
code/algorithm.
